...
import rospy
from tm_msgs.srv import Ask_img_AD
...
def Anomaly_detection(req):
    TEST_DATA_PATH =  req.file_path
    ...
    return Ask_img_ADResponse(resnet18_test_odin)
...
# Setup ROS service and server
rospy.init_node('Image_anomaly_detection_server',anonymous=True)
s = rospy.Service('Image_anomaly_detection_service', Ask_img_AD, Anomaly_detection)
rospy.spin()
