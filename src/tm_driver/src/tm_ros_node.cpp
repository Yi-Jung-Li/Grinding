    ...
    , has_goal_(false)
{
    ...
    joint_names_.push_back(prefix + "joint_1");
    joint_names_.push_back(prefix + "joint_2");
    joint_names_.push_back(prefix + "joint_3");
    joint_names_.push_back(prefix + "joint_4");
    joint_names_.push_back(prefix + "joint_5");
    joint_names_.push_back(prefix + "joint_6");
