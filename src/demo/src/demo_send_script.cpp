...
{    
  std::string cmd = "PTP(\"JPP\",0,0,0,0,0,0,35,200,0,false)";
  //std::string cmd = "PTP(\"CPP\",309,558,300,-150,0,90,40,200,0,false)";
  //std::string cmd = "Line(\"CPP\",309,558,350,-150,0,90,40,200,0,false)";
